...
$(EXEC): $(objC) $(objS) $(objP) $(objU) $(objT) $(objF) $(objN) $(objSe) $(objE)
	$(CC) $(COMP_FLAG) $(DEBUG_FLAG) $(objC) $(objS) $(objP) $(objU) $(objT) $(objF) $(objN) $(objSe) $(objE) -o $@
...
clean:
	-rm $(objC) $(objS) $(objP) $(objU) $(objT) $(objF) $(objN) $(objSe) $(objE)